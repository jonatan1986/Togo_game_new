...
public class Route : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        //Gizmos.DrawLine(new Vector2(controlPoints[0].position, controlPoints[0].position.y), new Vector2(controlPoints[1].position, controlPoints[1].position.y));

        //Gizmos.DrawLine(new Vector2(controlPoints[2].position, controlPoints[2].position.y), new Vector2(controlPoints[3].position, controlPoints[3].position.y));
